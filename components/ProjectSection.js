      ...
      <div className="project-wrap">
        <ul className="projects container">
          ...
          <li className="project">
            <div
              className="project__image"
              style={{ backgroundImage: `url('bezzy_logo.png'); background-color: #fff` }}></div>
            <div className="project__content">
              <h5 className="font-gradient project__category">Career</h5>
              <h3 className="project__title">Bezzy (Healthline)</h3>
              <p className="project__desc">Individual contributor on this social network for chronic illnesses. This was both a web app and native iOS/Android app. The web app was built with React/Next.js and the native apps were built with React Native.</p>
              <div className="project__buttons">
                <a className="project__link" href="https://www.healthline.com" target="_blank">Website</a>
              </div>
            </div>
          ...
          <li className="project">
            <div
              className="project__image"
              style={{ backgroundImage: `url('scc_logo.png'); background-color: #373737` }}></div>
            <div className="project__content">
